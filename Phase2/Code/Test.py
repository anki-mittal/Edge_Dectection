...
def main():
    ...
    Parser.add_argument('--ModelPath', dest='ModelPath', default='/home/ankit/Documents/STUDY/RBE594/HW0/amittal_hw0/Phase2/Checkpoints/19model.ckpt', help='Path to load latest model from, Default:ModelPath')
    ...
    label_list, pred_list = TestOperation(ImageSize, ModelPath, TrainSet, LabelsPathPred)
